...
#Preview {
    reUsableBottomSheet(sheetTitle: "Delete Collection?", sheetWarning: "Are you sure you want to delete this collection?", buttonTitle1: "cancel", buttonTitle2: "yes.delete".capitalized,button1Action: {},button2Action: {},button1Role: .cancel,button2Role: nil, showSheet: .constant(false))
}
